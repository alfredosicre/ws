...
public class Test02Dao {
	...
	public static void main(String[] args) {
		...
		// vemos los que contienen "al" en alguno de sus campos
		dao.buscar("al").forEach(System.out::println);
		System.out.println();
		
		// vemos el que tiene como id 44
		...
		// eliminamos el 88
		dao.eliminar(88);
		System.out.println(dao.buscar(88)); // me devuelve un null porque ya esta eliminado
